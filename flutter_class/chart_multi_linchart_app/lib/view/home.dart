...
class _HomeState extends State<Home> {
  ...
  addData2(){
    data2.add(DeveloperData(year: 2017, developers: 9000)); //requird쓰면 키값이 자동으로 보임
      ...
      body: Center(
        child: SizedBox(      //bar차트는 sizeBox에 있어야함
          ...
          child: SfCartesianChart(
            ...
            series: [ 
              LineSeries<DeveloperData, int>(    // < 타입지정!!!>
                color: Theme.of(context).colorScheme.primary,
                dataSource: data,                //data1 선차트
